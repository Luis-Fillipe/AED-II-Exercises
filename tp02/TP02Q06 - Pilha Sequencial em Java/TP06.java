...
class Lista {
	 ...
	 */
	public void inserir(Filme movie) {
	...
	public void printLista() {
		...
		for (int i = 0; i < n; i++) {
			System.out.print("[" + i + "] ");
			// array[i].print();
			System.out.println(array[i].getNome() + " " + array[i].getTituloOriginal() + " "
					+ padrao.format(array[i].getData()) + " " + array[i].getDuracao()
					+ " " + array[i].getGenero() + " " + array[i].getIdioma() + " " + array[i].getSituacao() + " "
					+ array[i].getOrcamento() + " "
					+ array[i].imprimirKeywords());
		}
	}
