...
Celula *newCelula(Movie elemento)
{
...
Movie movieNull()
{
    ...
    strcpy(filme.name, "null");
    strcpy(filme.original_title, "null");
    strcpy(filme.genre, "null");
    strcpy(filme.original_language, "null");
    strcpy(filme.situation, "null");
    strcpy(filme.keywords[0], "null");
    filme.release_date.day = 0;
    filme.duration = -1;
    filme.budget = -1;
    return filme;
}
...
void start()
{
    Movie filme = movieNull();
    primeiro = newCelula(filme);
    ultimo = primeiro;
}
...
void inserirInicio(Movie elemento)
{
...
void inserirFim(Movie elemento)
{
...
void quicksort(Celula *esq, Celula *dir)
{
    ...
    while (i->index <= j->index)
    {
        ...
        while (strcmp(i->elemento.situation, pivo->elemento.situation) > 0)
        {
            i = i->prox;
        }
        while (strcmp(i->elemento.situation, pivo->elemento.situation) < 0)
