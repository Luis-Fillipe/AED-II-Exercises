...
class quicksort {
	 ...
	 */
	public void quicksort(Filme[] filmes, int quantidade) {
	...
	public void insertion() {
		...
		for (int i = inicio; i < size - 1; i++) {
			...
			for (int j = i + 1; j < size; j++) {
				if (array[j].getSituacao().compareTo(array[menor].getSituacao()) == 0) {
...
public class TP06 {
	...
	public static void main(String[] args) throws ParseException, Exception {
		...
		try {
			...
			BufferedWriter bw = new BufferedWriter(new FileWriter("753192_quicksort.txt"));
