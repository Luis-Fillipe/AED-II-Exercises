...
class Pilha {
	...
	public String remover() throws Exception {
		...
		Celula i = topo;
		String nome = topo.elemento.getNome();
		topo = topo.prox;
		i.prox = null;
		i = null;
		this.n--;
	...
	private void mostraPilha(Celula i, int quant) {
		if (i.prox != null) {
			mostraPilha(i.prox, --quant);
			System.out.println("["+quant+"] "+ i.elemento.print());
		}
	}
